...
function Book({ id, title, image, date, pageCount, dateSimple }) {
  ...
  return (
    <BookContainer>
      ...
      <BookTextContainer isMobilePortrait={isMobilePortrait}>
        ...
        <BookText isMobilePortrait={isMobilePortrait}>
          {isMobilePortrait ? dateSimple : date}
        </BookText>
        <BookText isMobilePortrait={isMobilePortrait}>
          {pageCount} pages
        </BookText>
        <BookLink
          ...
          onClick={() => navigate("/order", { state: { id } })}
        >
          Order Now
        </BookLink>
      </BookTextContainer>
